    ...
    : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Usuario>().HasData(
            new Usuario { Id = 1, Username = "admin", Password = "admin123", RolId = 1, Email = "admin@example.com", FechaRegistro = DateTime.Now },
            new Usuario { Id = 2, Username = "gestor", Password = "gestor123", RolId = 2, Email = "gestor@example.com", FechaRegistro = DateTime.Now }
        );
